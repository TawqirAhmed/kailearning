...
@if($allITcourses->count() > 0)

    <section class="section-padding course-filter-section" id="itCourses">
        <div class="container">
            <div class="row align-items-center justify-content-between mb-30">
                <div class="col-xl-12">
                    <div class="heading text-center mb-40">
                        {{-- <span class="subheading">Course Trending</span> --}}
                        <h2 class="font-lg">Explore popular IT courses</h2>
                    </div>
        ...
        <div class="container-fluid container-padding" wire:ignore>        
            ...
            @foreach($allITcourses as $key=>$value)
